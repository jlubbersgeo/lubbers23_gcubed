...
#%%
def harker_plot(
    data,x_element, y_elements, axes, custom_ylabels=None, categorical=None,legend_loc = "best", **sct_kwargs
):
    """
...
# Plot LeMaitre lines
def add_LeMaitre_fields(plot_axes,x_lim = 0, fontsize=8, color=(0.6, 0.6, 0.6), **kwargs):
